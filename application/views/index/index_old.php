<header>
				...
				<div class="row">
					<div class="3u">
						<section>
							<a href="#" class="image full"><img src="<?=public_path()?>images/pics01.jpg" alt="" /></a>
					...
					<div class="3u">
						<section>
							<a href="#" class="image full"><img src="<?=public_path()?>images/pics11.jpg" alt="" /></a>
					...
					<div class="3u">
						<section>
							<a href="#" class="image full"><img src="<?=public_path()?>images/pics12.jpg" alt="" /></a>
					...
					<div class="3u">
						<section>
							<a href="#" class="image full"><img src="<?=public_path()?>images/pics13.jpg" alt="" /></a>
					...
					<!-- Content -->
						<div class="8u skel-cell-important">
							<section id="content">
								...
								<p><a href="#" class="image full"><img src="<?=public_path()?>images/pics02.jpg" alt=""></a></p>
